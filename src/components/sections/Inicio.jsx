                ...
                <div className="text-center z-10 px-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-8">
                        <div className="bg-white/5 border border-white/10 rounded-xl px-6 py-3 min-w-[110px]">
                            <div className="text-2xl font-bold bg-gradient-to-r from-green-500 to-cyan-400 bg-clip-text text-transparent whitespace-nowrap">6+</div>
                            <div className="text-xs text-gray-400 uppercase tracking-wide mt-1">Años evolución</div>
                        </div>
                        <div className="bg-white/5 border border-white/10 rounded-xl px-6 py-3 min-w-[110px]">
                            <div className="text-2xl font-bold bg-gradient-to-r from-green-500 to-cyan-400 bg-clip-text text-transparent whitespace-nowrap">12+</div>
                            <div className="text-xs text-gray-400 uppercase tracking-wide mt-1">Proyectos</div>
                        </div>
                        <div className="bg-white/5 border border-white/10 rounded-xl px-6 py-3 min-w-[110px]">
                            <div className="text-2xl font-bold bg-gradient-to-r from-green-500 to-cyan-400 bg-clip-text text-transparent whitespace-nowrap">95%+</div>
                            <div className="text-xs text-gray-400 uppercase tracking-wide mt-1">SLA/ANS</div>
                        </div>
                        <div className="bg-white/5 border border-white/10 rounded-xl px-6 py-3 min-w-[110px]">
                            <div className="text-2xl font-bold bg-gradient-to-r from-green-500 to-cyan-400 bg-clip-text text-transparent whitespace-nowrap">ITIL v4</div>
                            <div className="text-xs text-gray-400 uppercase tracking-wide mt-1">Certificado</div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-sm text-gray-400 mb-8">
                        <span>
                            <svg className="w-3.5 h-3.5 text-green-500 inline-block mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
