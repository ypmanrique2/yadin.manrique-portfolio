...
export const Sobre_mi = () => {
    ...
    const especialidadesChips = ["Clean Arch", "Hexagonal", "DDD", "SOLID", "MicroFront-Ends (MFE)", "REST API", "CI/CD", "OWASP Top 10", "SDD", "ITIL v4", "Scrum", "GraphQL solo-lectura (Spring for GraphQL)", "SEO AI First", "human-in-the-loop", "SEO organic"];
