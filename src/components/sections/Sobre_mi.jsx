...
export const Sobre_mi = () => {
    ...
    const especialidadesChips = ["EDA", "Scrum", "Clean Arch", "Hexagonal", "DDD", "SOLID", "MicroFront-Ends (MFE)", "REST API", "CI/CD", "OWASP Top 10", "SDD", "ITIL v4", "GraphQL solo-lectura (Spring for GraphQL)", "SEO AI First", "human-in-the-loop", "SEO organic"];
    const cloudSeguridadChips = ["Kafka KRaft", "SSE", "Docker / Kubernetes (k3d)", "GitHub Actions", "Jenkins", "Render", "Fly.io", "GCP", "Azure", "Aiven", "Keycloak", "NextAuth", "RBAC", "Prometheus", "Grafana", "Elasticsearch", "Kibana", "Micrometer", "JasperReports"];
