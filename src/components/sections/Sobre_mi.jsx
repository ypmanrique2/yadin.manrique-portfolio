...
export const Sobre_mi = () => {
    ...
    const cloudSeguridadChips = ["Kafka KRaft", "SSE", "Docker / Kubernetes (k3d · AKS)", "GitHub Actions", "Jenkins", "Render", "Fly.io", "GCP", "Azure", "Aiven", "Keycloak", "NextAuth", "RBAC", "Prometheus", "Grafana", "Elasticsearch", "Kibana", "Micrometer", "JasperReports"];
