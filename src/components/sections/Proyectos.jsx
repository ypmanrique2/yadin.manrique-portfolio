...
const projects = [
    {
        ...
        chips: ["Java 21", "Spring Boot", "Spring Modulith", "X-Tenant-ID", "Angular 21", "Kafka", "MongoDB", "NgRX", "Kubernetes (K8s)", "Hexagonal Architecture", "DDD", "Transactional Outbox", "Angular Signals", "DLT", "Idempotency", "Resilience4j", "Virtual Threads", "Spring Security", "JWT", "RBAC", "Clean Architecture", "Multi-Tenancy", "OWASP", "IDOR", "EDA", "Docker", "k3d", "Testcontainers", "GitHub Actions"],
